...
export default class TerrainChunk {
  ...
  RebuildMeshFromData(data) {
    ...
    this._geometry.setAttribute("tangent", new THREE.Float32BufferAttribute(data.tangents, 4));
    ...
    this._geometry.setAttribute("uv", new THREE.Float32BufferAttribute(data.uvs, 2));
  }
  ...
  *_Rebuild() {
    ...
    this._geometry.setAttribute("position", new THREE.Float32BufferAttribute(uiPositions, 3));
    this._geometry.setAttribute("color", new THREE.Float32BufferAttribute(uiColours, 3));
    this._geometry.setAttribute("normal", new THREE.Float32BufferAttribute(uiNormals, 3));
    this._geometry.setAttribute("tangent", new THREE.Float32BufferAttribute(uiTangents, 4));
    this._geometry.setAttribute("weights1", new THREE.Float32BufferAttribute(uiWeights1, 4));
    this._geometry.setAttribute("weights2", new THREE.Float32BufferAttribute(uiWeights2, 4));
    this._geometry.setAttribute("uv", new THREE.Float32BufferAttribute(uiUVs, 2));
  }
}
